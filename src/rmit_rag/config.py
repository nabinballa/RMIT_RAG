...
class Settings:
    ...
    max_response_length: int = int(os.getenv("MAX_RESPONSE_LENGTH", "512"))  # Limit response length
    context_window: int = int(os.getenv("CONTEXT_WINDOW", "2048"))  # Limit context window
    batch_size: int = int(os.getenv("BATCH_SIZE", "32"))  # Embedding batch size
